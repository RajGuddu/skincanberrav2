			...
			<div class="col-12 col-lg-6">
				...
				<div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
						...
						<div class="item border-bottom py-3">
							<div class="row justify-content-between align-items-center">
								...
								<div class="col text-end">
									...
									<div class="item-data"><img class="profile-image" src="{{ url(IMAGE_PATH.session('image')) }}"
											alt=""></div>
								</div><!--//col-->
						...
						<div class="item border-bottom py-3">
							<div class="row justify-content-between align-items-center">
								...
								<div class="col text-end">
									...
									<div class="item-data">{{ session('name') }}</div>
								</div><!--//col-->
							</div><!--//row-->
						</div><!--//item-->
						<div class="item border-bottom py-3">
							<div class="row justify-content-between align-items-center">
								<div class="col-auto">
									<input type="text" name="email" id="email" value="{{ old('email', $profile->email ?? '') }}" class="form-control">
									@error('email') <span class="text-danger">{{ $message }}</span> @enderror
								</div><!--//col-->
								<div class="col text-end">
									<div class="item-label"><strong>Email</strong></div>
									<div class="item-data">{{ session('email') }}</div>
								</div><!--//col-->
							</div><!--//row-->
						</div><!--//item-->
						<div class="item border-bottom py-3">
					...
					<div class="app-card-footer p-4 mt-auto">
						<button type="submit" class="btn app-btn-secondary">Manage Profile</button>
					</div><!--//app-card-footer-->
				</div><!--//app-card-->
				</form>
			</div><!--//col-->
				...
				<div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
					...
					<div class="app-card-body px-4 w-100">
						...
						<div class="item border-bottom py-3">
							<div class="row justify-content-between align-items-center">
								<div class="col-auto ">
									<input type="password" name="oldpwd" id="oldpwd" value="{{ old('oldpwd') }}" class="form-control">
						...
						<div class="item border-bottom py-3">
							<div class="row justify-content-between align-items-center">
								<div class="col-auto">
									<input type="password" name="pwd" id="pwd" value="{{ old('pwd') }}" class="form-control">
						...
						<div class="item border-bottom py-3">
							<div class="row justify-content-between align-items-center">
								<div class="col-auto">
									<input type="password" name="cpwd" id="cpwd" value="{{ old('cpwd') }}" class="form-control">
					...
					<div class="app-card-footer p-4 mt-auto">
						<button type="submit" class="btn app-btn-secondary">Manage Security</button>
					</div><!--//app-card-footer-->
