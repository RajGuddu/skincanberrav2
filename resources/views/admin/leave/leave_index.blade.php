...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-fluid">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            <div class="col-auto">
                <h1 class="app-page-title mb-4">Leave Management</h1>
            </div>
            <div class="col-auto">
                ...
                @if(is_privilege(21,2))
                <a href="{{ url('admin/leave').'?add=1' }}" class="btn btn-secondary ms-2">Add</a>
                @endif
            </div>
                            ...
                            <table class="table app-table-hover mb-0 text-left table-fixed">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endphp
                                        <td style="{{ $tdStyle }}">
                                            @if(is_privilege(21,3))
                                            <a class="btn-sm app-btn-secondary" href="{{ url('admin/leave/'.$item->id) }}">Edit</a>
                                            @endif
                                            @if(is_privilege(21,4))
                                            <a class="btn-sm app-btn-secondary" onclick="return confirm('Are u sure?')"
                                                href="{{ url('admin/delete_leave/'.$item->id) }}">Delete</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
                        ...
                        <form action="{{ url()->current() }}" id="CourseForm" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="user_id" id="user_id" class="form-control">
                                    ...
                                    <option value="{{ $list->user_id }}" {{ (isset($record) && $record->user_id == $list->user_id)?'selected':''}}>{{ $list->name }}</option>
                                    @endforeach
                                    @endif
                                </select>
                            ...
                            <a href="{{ url('admin/leave') }}" class="btn btn-secondary text-white" id="">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
