...
<div class="app-content pt-3 p-md-3 p-lg-4">
	<div class="container-fluid">
		...
		<div class="row g-3 mb-4 align-items-center justify-content-between">
			<div class="col-auto">
				<h1 class="app-page-title mb-0">Image for Real Result</h1>
			</div>
			<div class="col-auto">
				...
				<div class="table-responsive">
					<table class="table app-table-hover mb-0 text-left">
						<thead>
							<tr>
								<th class="cell">#</th>
								<th class="cell">Alt Text</th>
								<th class="cell">Title Text</th>
						...
						<tbody>
							...
							<tr>
								<td class="cell">{{ $n++ }}</td>
								<td class="cell">{{ $list->alt }}</td>
								<td class="cell">{{ $list->title }}</td>
								<td class="cell">
