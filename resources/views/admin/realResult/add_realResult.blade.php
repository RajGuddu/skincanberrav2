...
<div class="app-content pt-3 p-md-3 p-lg-4">
	<div class="container-fluid">
		<div class="d-flex align-items-center justify-content-between">
			<h1 class="app-page-title">Add Images for Real Result</h1>
			<div class="">
						...
						<form class="" action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
							...
							<div class="main-sec">
								<div class="single-sec">
									<div class="mb-3">
										<label for="images" class="form-label">Image (1000 X 1500 px)</label>
									...
									<div class="d-flex justify-content-end mb-3 ">
										<button type="button" class="btn app-btn-primary text-light" onclick="add_section()">Add</button>
									</div>
								</div>
							</div>
...
<script>
	...
	function add_section(){
		var sectionHtml = '<div class="single-sec">'+
			'<div class="mb-3">'+
				'<label for="images'+secno+'" class="form-label">Image (1000 X 1500 px)</label>'+
