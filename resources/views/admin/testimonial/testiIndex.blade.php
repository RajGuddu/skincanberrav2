...
<div class="app-content pt-3 p-md-3 p-lg-4">
	<div class="container-fluid">
		...
		<div class="row g-3 mb-4 align-items-center justify-content-between">
			<div class="col-auto">
				<h1 class="app-page-title mb-0">Testimonials</h1>
			</div>
			<div class="col-auto">
				<div class="page-utilities">
					<div class="row g-2 justify-content-start justify-content-md-end align-items-center">
						...
						<div class="col-auto">
							<a class="btn app-btn-secondary" href="{{ url('admin/testimonials') }}"> Refresh </a>
						</div>
						@if(is_privilege(12,2))
						<div class="col-auto">
					...
					<table class="table app-table-hover mb-0 text-left">
						<thead>
							<tr>
								...
								<th class="cell">Photo/Thumbnail</th>
						...
						<tbody>
							...
							if($list->photo != '')
								$img = $list->photo;
							elseif($list->thumb_image != '')
								$img = $list->thumb_image;
							
							@endphp
							<tr>
								<td class="cell">{{ $n++ }}</td>
								<td class="cell">{{ $list->name }}</td>
								<td class="cell">{{ $list->description }}</td>
								<td class="cell">
									@if($img != '')
									<img src="{{ url(IMAGE_PATH.$img) }}" alt="testimonial-image" width="70px" height="60px"></td>
									@else
										{{ '--' }}
									@endif
								<td class="cell">
								...
								<td class="cell">
									...
									@if(is_privilege(12,3))
									<a class="btn-sm app-btn-secondary" href="{{ url('admin/add_edit_testimonial/'.$list->id) }}">Edit</a>
									@endif
									@if(is_privilege(12,4))
									<a class="btn-sm app-btn-secondary" onclick="return confirm('Are u sure?')" href="{{ url('admin/delete_testimonial/'.$list->id) }}">Delete</a>
									@endif
